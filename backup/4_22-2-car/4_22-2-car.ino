...
const int Blower_PWM_Start = Blower_PWM_Base + 150 - 20; //吹動車子的 PWM 值
const int Blower_PWM_Start_Back = Blower_PWM_Base - 110; //吹動車子的 PWM 值
const int Blower_PWM_Run = Blower_PWM_Base + 90 - 20; //吹動車子的 PWM 值
const int Blower_PWM_RunBack = Blower_PWM_Base - 70; //吹動車子的 PWM 值
...
int IR_Rotating_Angle[7] = {-5, 0, 5,     -10, -5, 5, 10};
